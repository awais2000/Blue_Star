...
                <tfoot>
                <tr>
                  <td colspan="4" style="text-align: right; font-weight: bold; border-top: 1px dashed #000; padding-top: 5px;">Total</td>
                  <td style="text-align: right; font-weight: bold; border-top: 1px dashed #000; padding-top: 5px;">${formattedSumOfTotal} AED</td>
                </tr>
                <tr>
                  <td colspan="4" style="text-align: right; font-weight: bold;">Total VAT</td>
                  <td style="text-align: right; font-weight: bold;">${formattedSumOfVat} AED</td>
                </tr>
                <tr>
                  <td colspan="4" style="text-align: right; font-weight: bold;">Disc</td>
                  <td style="text-align: right; font-weight: bold;">${formattedNewDiscount} AED</td>
                </tr>
                <tr>
                  <td colspan="4" style="text-align: right; font-weight: bold; border-top: 1px dashed #000; padding-top: 5px;">Grand Total</td>
                  <td style="text-align: right; font-weight: bold; border-top: 1px dashed #000; padding-top: 5px;">${finalGrandTotal} AED</td>
                </tr>
              </tfoot>
            </table>
          </div>
